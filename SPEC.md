...
Zentriert unter dem Symbol, wie davor, sah es anders aus als jedes Menü daneben. **Escape schließt das Panel** wie jedes Menü (13.09.2026); steht der Cursor in der Erfassung, verwirft das erste Escape den Entwurf, das zweite schließt — Spotlights zwei Schritte. Verliert das Panel den Tastaturfokus ohne Klick (⌘-Tab), schließt es ebenfalls, wie ein Menü — sonst stünde es da, ohne dass Escape es noch erreichte. Herleitung und die verworfenen Formen
...
| Karte | Papier mit Streifen, Schatten, Badge, Wiederholungs-Icon | Menüzeile (26 pt, 13 pt Schrift): Punkt in Listenfarbe, Prioritätsmarken, Titel, Fälligkeit **nur bei Heute und Überfällig**, als schlichter Text rechts (11 pt; Überfällig in Systemrot, wie Erinnerungen selbst es schreibt, Heute in der Textfarbe, die Verweildauer daneben sekundär — die drei Gewichte des Board-Badges als drei Textfarben; nicht die Kapsel des Boards: dreimal gestapelt war sie das Lauteste im Panel und eine stehende Anklage, 13.09.2026). Zeigt eine Zeile des Abschnitts eine Fälligkeit oder eine Verweildauer, halten **alle** seine Zeilen die Spalte dafür frei, damit die Titel auf einer Flucht enden — wie ein Menü allen Einträgen die Kürzel-Spalte gibt, sobald einer eins hat; die Spalten sind Mindestbreiten, ein längeres Wort schiebt den Titel, statt selbst gekürzt zu werden — graue Daten sind Planung, und die findet auf dem Board statt; Hover hebt die Zeile als hellere Glasschicht |
