...
Die Kurve ist ein **Ease-in-out über 0,35 s** (bis 13.09.2026 0,5 s; im Panel, wo dieselbe Falz spielt, las sich das als langsam — ein Wert für Board und Panel, `Board.foldDuration`) und ausdrücklich **keine Feder.** Eine Feder
...
Kartenwechsel, hier gut die zehnfache Strecke in anderthalbfacher Zeit (nicht
proportional — das wären Sekunden), im Tempo der Aufklapp-Bewegungen des Systems.
...
an einer Stelle (14.09.2026, seit 23.09.2026 nur noch eine):** Eine **verschobene** Zeile kommt in ihrem neuen Abschnitt von der Seite, von der sie
...
|---|---|---|
| Spurkopf | Name und Zähl-Chip | Name und Zahl als Text, 13 pt halbfett sekundär, **ohne Symbol davor** — der Abschnittskopf von Apples WLAN-Panel („Bekanntes Netzwerk"), gemessen 23.09.2026; dunkel und fett setzt Apple nur den einen Titel eines Panels, und das Tablett hat keinen; die teale Kapsel nur, solange der Abschnitt über seinem Limit liegt. Zwischen zwei Abschnitten eine Haarlinie wie in den Systempanels |
| Hierarchie | Papier in der Mulde | **ein Baum, keine Liste:** der Kopf steht am Rand, seine Zeilen rücken ein (22 pt) — wie die Seitenleiste von Finder und Erinnerungen. Zwei Glyphenspalten, zwei Ebenen: am Rand nur die App-Symbole der Fußzeilen, eingerückt nur Listenpunkte |
