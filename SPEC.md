...
| Karte | Papier mit Streifen, Schatten, Badge, Wiederholungs-Icon | Menüzeile (26 pt, 13 pt Schrift): Punkt in Listenfarbe, Prioritätsmarken, Titel, Fälligkeit **nur bei Heute und Überfällig**, als schlichter Text rechts (11 pt, sekundär; Überfällig in Rot, wie Erinnerungen selbst es schreibt — nicht die Kapsel des Boards: dreimal gestapelt war sie das Lauteste im Panel und eine stehende Anklage, 13.09.2026). Hat eine Zeile des Abschnitts eine Fälligkeit, halten **alle** seine Zeilen die Spalte dafür frei, damit die Titel auf einer Flucht enden — wie ein Menü allen Einträgen die Kürzel-Spalte gibt, sobald einer eins hat — graue Daten sind Planung, und die findet auf dem Board statt; Hover hebt die Zeile als hellere Glasschicht |
