...
1. **Symbole vor den Köpfen**, die die Stufe zeigen, nicht dekorieren — `tray`,
   ...
   **Am 23.09.2026 wieder entfernt:** Neben Apples eigenen Panels (WLAN, Bluetooth)
   wirkten die Köpfe fremd; dort sind Abschnittsköpfe bloßer grauer Text, Symbole
   tragen nur die Zeilen (Messung in der Tabelle unten).
...
| 23.09.2026 | Köpfe gegen WLAN und Bluetooth, auf diesem Mac fotografiert | Anlass: „die Überschriften sind immer grau, bei anderen Apps nicht“ (Nutzer). Ein erster Versuch ohne Messung setzte die Köpfe 13 pt fett in der Primärfarbe — „sieht weiterhin sehr seltsam und nicht nativ aus“ (Nutzer). Gemessen: Apple setzt **einen** Titel dunkel und fett („WLAN“, „Bluetooth“, mit Schalter). Die Abschnittsköpfe darunter („Persönlicher Hotspot“, „Bekanntes Netzwerk“, „Andere Netzwerke“) sind 13 pt halbfett grau, **ohne Symbol**, bündig mit den Zeilen; Symbole tragen nur die Zeilen, in 26-pt-Kreisen. Die graue Farbe war also richtig, das Symbol vor dem Kopf war das Fremde. | Köpfe als bloßer Text, 13 pt halbfett sekundär; die Stufen-Symbole vom 12.09. entfallen. Nicht übernommen, auf Wunsch des Nutzers: Zeilen bündig unter dem Kopf (schon am 12.09. verworfen, mit 7-pt-Punkten statt Kreis-Symbolen lasen sich sieben gleiche Zeilen) und ein Titel „Glass Kanban“ über allem (eine Zeile ohne Aufgabe). |
